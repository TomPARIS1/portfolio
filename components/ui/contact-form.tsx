...
export function ContactForm() {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        const submitTime = Date.now() - submitTimeRef.current;
        if (submitTime < 3000) {
            console.log("Soumission trop rapide, probablement un bot");
        ...
        formData.append("botcheck", honeypot as string);
        ...
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-neutral-900">
            ...
            >
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input 
                        id="email" 
                        placeholder="firstrule@gmail.com" 
                        type="email" 
                        name="email" 
                        required
                        disabled={isSubmitting}
